...
AppId=FHUOR2-RU-ALPHA-1.0.2
AppPublisher=FHUORs2 Localisation Team
...
OutputDir=.\Output
OutputBaseFilename=FHUORs2_RU_Alpha_1.0.2_Setup
...
VersionInfoProductName=FHUORs2 Russian Localisation Alpha
...
[Messages]
WelcomeLabel2=Установка русской локализации для Five Hearts Under One Roof season 2 (Alpha 1.0.2)
...
[Components]
Name: translation; Description: "Русская локализация (Alpha 1.0.2)"; Types: full; Flags: fixed
...
[Icons]
Name: "{group}\FHUORs2 (Russian Alpha)"; Filename: "{app}\FHUOR2.exe"; Comment: "Five Hearts Under One Roof season 2 with Russian Localisation"
Name: "{group}\Удалить русскую локализацию"; Filename: "{uninstallexe}"
Name: "{commondesktop}\FHUORs2 (Russian Alpha)"; Filename: "{app}\FHUOR2.exe"; Comment: "Запустить с русской локализацией"
...
begin
  ...
  begin
    MsgBox('Русская локализация FHUORs2 Alpha 1.0.2 успешно установлена!' + #13#10#13#10 +
